...
class IOController {
    ...
    constructor(dataSource, config, extraData, mediaElement) {
        ...
        this._stashInitialSize = 4096 * 768 * this.element.playbackRate;  // default initial size: 384KB
        ...
        this._bufferSize = 1024 * 4096 * this.element.playbackRate;  // initial size: 3MB
        ...
        this._speedNormalizeList = [64, 128, 256, 384, 512, 768, 1024, 1536, 2048, 4096, 8192, 16384];
